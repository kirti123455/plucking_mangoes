...
function setup() {
  ...
  mango13=new mango(700,160,20);
  mango14=new mango(600,160,40);
  mango15=new mango(500,120,30);
  mango16=new mango(700,230,40);
  mango17=new mango(600,60,40);
  mango18=new mango(550,260,30);

	treeObj=new tree(1050,580);
  treeObj1=new tree(600,580);
